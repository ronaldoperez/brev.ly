...
import { getUrlByShortCode } from '@/app/functions/get-url-by-shortcode'
import { isRight, unwrapEither } from '@/shared/either'

export const getUrlByShortCodeRoute: FastifyPluginAsyncZod = async server => {
  server.get(
    '/urls/shortcode/:shortCode',
    {
      schema: {
        tags: ['urls'],
        summary: 'Get a url by shortcode',
        params: z.object({
          shortCode: z.string(),
        }),
        response: {
